...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afgo](#runset-acapy-afgo) | acapy-main<br>0.7.1 | afgo-interop<br>unknown | acapy-main<br>0.7.1 | acapy-main<br>0.7.1 | pre-AIP 2.0 | [**3 / 3<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-afgo/reports/latest/index.html?redirect=false#behaviors) |
...
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.1.0-alpha.233 | acapy-main<br>0.7.1 | javascript<br>0.1.0-alpha.233 | javascript<br>0.1.0-alpha.233 | AIP 1.0 | [**4 / 17<br>23%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Mon Sep 13 01:21:49 UTC 2021*
```
...
*Last run: Mon Sep 13 01:31:17 UTC 2021*
```
...
*Last run: Mon Sep 13 01:35:10 UTC 2021*
```
...
*Last run: Mon Sep 13 01:48:40 UTC 2021*
```
...
*Last run: Mon Sep 13 01:38:38 UTC 2021*
```
...
*Last run: Mon Sep 13 01:56:56 UTC 2021*
```
...
*Last run: Mon Sep 13 01:52:03 UTC 2021*
```
...
```tip
**Latest results: 4 out of 17 (23%)**


*Last run: Mon Sep 13 02:24:03 UTC 2021*
```
...
*Last run: Mon Sep 13 02:08:34 UTC 2021*
```
